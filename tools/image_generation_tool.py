...
_FAL_CLIENT_IMPORT_ERROR = "fal_client is not installed. Install with: pip install fal-client"


def _require_fal_client():
    if fal_client is None:
        raise ImportError(_FAL_CLIENT_IMPORT_ERROR)
    return fal_client
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"❌ {_FAL_CLIENT_IMPORT_ERROR}")
        raise SystemExit(1)
